              ...
              @endforeach --}}
                ...
                <div class="form-group">
                    ...
                    <select name="size[]" class="form-control selectpicker" multiple data-live-search="true">
                        ...
                        <option value="30">30 / 18.5 cm</option>
                        <option value="31">31 / 19 cm</option>
                        <option value="32">32 / 20 cm</option>
                        <option value="33">33 / 20.5 cm</option>
                        <option value="34">34 / 21.5 cm</option>
                        <option value="35">35 / 22 cm</option>
                        <option value="36">36 / 22.5 cm</option>
                        <option value="37">37 / 23 cm</option>
