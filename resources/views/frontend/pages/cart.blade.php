                                ...
                                @if (Helper::getAllProductFromCart())
                                    @foreach (Helper::getAllProductFromCart() as $key => $cart)
                                        <tr>
                                            ...
                                            <td class="qty" data-title="Size" style="text-align: center;">
                                                <span class="product-quantity">
                                                    {{ $cart->size }}
                                                </span>
                                            <td class="total-amount cart_single_price" data-title="Total"><span
                                                    class="money">Rp. {{ number_format($cart['amount'], 0, ',', '.') }}
                                                </span></td>
                            ...
                            <div class="col-lg-4 col-md-7 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        @endphp
                                        @if (session()->has('coupon'))
                                            <li class="last" id="order_total_price">Yang harus di bayar<span>Rp.
                                                    {{ number_format($total_amount, 0, ',', '.') }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">Yang harus di bayar<span>Rp.
                                                    {{ number_format($total_amount, 0, ',', '.') }}</span></li>
                                        @endif
