    ...
    <script>
        $(document).ready(function() {
            ...
            if ($("#slider-range").length > 0) {
                const max_value = parseInt($("#slider-range").data('max')) || 5000000; // Default max value
                const min_value = parseInt($("#slider-range").data('min')) || 0; // Default min value
                const currency = $("#slider-range").data('currency') || 'Rp '; // Default currency (Rupiah)

                // Ambil nilai range price dari input hidden jika ada
                let price_range = min_value + '-' + max_value;
                if ($("#price_range").length > 0 && $("#price_range").val()) {
                    price_range = $("#price_range").val().trim();
                }

                // Pisahkan nilai min dan max dari range yang ada
                ...
                $("#slider-range").slider({
                    ...
                    slide: function(event, ui) {
                        // Format angka menggunakan format Rupiah ketika slider digeser
                        $("#amount").val(formatRupiah(ui.values[0]) + " - " + formatRupiah(ui.values[
                            1]));
            ...
            // Jika input amount ada, set nilai awal untuk slider
            if ($("#amount").length > 0) {
                const m_currency = $("#slider-range").data('currency') || 'Rp ';
                $("#amount").val(formatRupiah($("#slider-range").slider("values", 0)) +
            ...
            function formatRupiah(angka) {
                ...
                return 'Rp ' + rupiah; // Hanya satu 'Rp' yang akan ditambahkan
            }
        });
    </script>
@endpush
