                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        @php
                            $settings = DB::table('settings')->get();
                        @endphp
                        <a href="{{ route('home') }}"><img src="{{ $settings[0]->logo }}" alt="logo"
                                style="max-width: 50%; height: auto; object-fit: contain;"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                                        ...
                                        @foreach (Helper::getAllProductFromWishlist() as $data)
                                            ...
                                            <li>
                                                ...
                                                <p class="quantity">{{ $data->quantity }} x - <span
                                                        class="amount">Rp.{{ number_format($data->price, 0, ',', '.') }}</span>
                                                    <span>({{ $data->size }})</span>
                                                </p>
                                            </li>
                                        @endforeach
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            ...
                                            <span class="total-amount">Rp.
                                                {{ number_format(Helper::totalWishlistPrice(), 0, ',', '.') }}</span>
                                        </div>
                                        ...
                                        @foreach (Helper::getAllProductFromCart() as $data)
                                            ...
                                            <li>
                                                ...
                                                <p class="quantity">{{ $data->quantity }} x - <span class="amount">Rp.
                                                        {{ number_format($data->price, 0, ',', '.') }}</span><span>
                                                        ({{ $data->size }})
                                                    </span>
                                                </p>
                                            </li>
                                    ...
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="@if (Request::path() == 'product-grids' || Request::path() == 'product-lists') active @endif"><a
                                                    ...
                                                    class="new bg-danger">New</span></li>
