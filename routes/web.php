...
Route::get('password-reset-submit', function() {
...
//     ];
//     Mail::to('iwanbahri67@gmail.com')->send(new \App\Mail\TestMail($details));
...
Route::get('/checkout/payment/{id}', 'OrderController@payment')->name('payment')->middleware('user');
Route::get('/payment/success', 'OrderController@paymentSuccess')->name('payment-success')->middleware('user');
// Wishlist
